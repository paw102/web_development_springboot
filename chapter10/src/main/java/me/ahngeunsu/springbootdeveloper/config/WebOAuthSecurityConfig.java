...
//  import org.springframework.security.config.annotation.web.configurers.AbstractHttpConfigurer;
    ...
    //  바로 다음에 작성 할 파일들이므로 빨간 줄 떠도 상관 X
    @Bean
...
/*
    OAuth2 에 필요한 정보를 세션이 아닌 쿠키에 저장해 쓸 수 있도록 인증 요청과 관련된 상태를 저장 할 저장소 구현

    config/oauth 내에 OAuth2AuthorizationRequestBasedOnCookieRepository 클래스 생성
 */
